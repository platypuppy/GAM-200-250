  ...
  namespace ObjectSerializer {
    ...
    */
    ...
    DeSerializable* createObject(const std::string& path,
      ...
      DeSerializable* object = DeSerializable_Find::NewObject(name);
      if (!object)
        return NULL;
    ...
    */
    ...
    std::vector<DeSerializable*>* createDocumentObjects(const std::string& path,
      ...
      DeSerializable* obj = DeSerializable_Find::NewObject("DEFAULT");
      if (!obj)
        return NULL;
    ...
    */
    ...
    std::vector<DeSerializable*>* DeSerialize(const std::string& filepath) {
      if (filepath.find(" ") !=  std::string::npos) {
        JSONMemberError(filepath, "-", "file names & paths with spaces are not supported");
        return NULL;
      }
